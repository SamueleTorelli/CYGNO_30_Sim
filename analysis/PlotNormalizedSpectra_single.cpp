...
std::map<std::string, std::map<std::string, double >> Contaminant = {  
  {"GEMs",          { {"U235",5.45e-3}, {"Th231",5.45e-3}, {"Pa231",5.45e-3}, {"Ac227",5.45e-3}, {"Th227",5.45e-3}, {"Ra223",5.45e-3}, {"Rn219",5.45e-3}, {"Po215",5.45e-3}, {"Pb211",5.45e-3}, {"Bi211",5.45e-3}, {"Tl207",5.45e-3}, {"Fr223",5.45e-3}, {"Po211",5.45e-3}      } },
};  // call Contaminant["Cat"]["U238"]

std::map<std::string, std::map<std::string, double >> NEvents = {  
  {"GEMs",      {{"U235",1e5}, {"Th231",1e5}, {"Pa231",1e5}, {"Ac227",1e5}, {"Th227",1e5/0.9862}, {"Ra223",1e5}, {"Rn219",1e5}, {"Po215",1e5}, {"Pb211",1e5}, {"Bi211",1e5}, {"Tl207",1e5/0.9973}, {"Fr223",1e5/0.0138}, {"Po211",1e5/0.0027}  } },
